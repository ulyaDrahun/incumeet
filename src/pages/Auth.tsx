        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-2">
              {mode === "signin" ? "Sign in to access your meetings"
                : mode === "signup" ? "Start organizing your meetings with AI"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={isLoading}>
              {isLoading ? <><Loader2 className="h-4 w-4 animate-spin mr-2" /> Please wait...</>
                : mode === "signin" ? "Sign In"
          ...
          <div className="mt-6 text-center">
            {mode === "forgot" ? (
              <button onClick={() => setMode("signin")} className="text-sm text-primary font-medium hover:underline">
                Back to sign in
              </button>
            ) : (
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-8">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="text-center text-primary-foreground max-w-md">
          ...
          <p className="text-primary-foreground/80">
            Upload any meeting recording or transcript and get instant AI summaries with key decisions and action items.
          </p>
        </motion.div>
      </div>
    </div>
